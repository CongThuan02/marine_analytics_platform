...
class _CreateReminderBottomSheetState extends State<CreateReminderBottomSheet> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Text('Thêm mới nhắc nhở', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                const Spacer(),
                      ...
                      child: Column(
                        ...
                        children: [
                          DropdownButtonFormField<DepartmentModel>(
                            ...
                            decoration: const InputDecoration(labelText: 'Phòng ban', prefixIcon: Icon(Icons.business)),
                            items: _departments.map((dept) {
                              return DropdownMenuItem(value: dept, child: Text(dept.name ?? 'No name'));
                            }).toList(),
                            onChanged: (value) => setState(() => _selectedDepartment = value),
                            validator: (value) => value == null ? 'Vui lòng chọn phòng ban' : null,
                          ),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: (value) => setState(() => _frequency = value ?? 'Hàng ngày'),
                          ),
                          const SizedBox(height: 16),
                          TextFormField(
                            controller: _messageController,
                            decoration: const InputDecoration(labelText: 'Ghi chú', prefixIcon: Icon(Icons.message)),
                            maxLines: 3,
                          ),
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Đã thêm nhắc nhở mới')));
    }
  }
