...
abstract class ReminderRemoteDataSource {
  Future<List<ReminderModel>> fetchAll();
  Future<List<ReminderModel>> fetchByDepartment(String departmentId);
  Future<ReminderModel> create(ReminderModel reminder);
  Future<ReminderModel> update(String id, ReminderModel reminder);
