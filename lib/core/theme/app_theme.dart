...
/// Theme màu thân thiện với môi trường và thiên nhiên
class AppTheme {
  // Màu chính - Xanh lá cây
  static const Color primaryGreen = Color(0xFF2E7D32); // Xanh lá đậm
  static const Color primaryGreenLight = Color(0xFF66BB6A); // Xanh lá sáng
  static const Color primaryGreenDark = Color(0xFF1B5E20); // Xanh lá rất đậm

  // Màu phụ - Xanh ngọc
  static const Color secondaryTeal = Color(0xFF00796B); // Xanh ngọc
  static const Color secondaryTealLight = Color(0xFF26A69A); // Xanh ngọc nhạt
  static const Color secondaryTealDark = Color(0xFF004D40); // Xanh ngọc đậm

  // Màu nền
  static const Color backgroundLight = Color(0xFFF1F8E9); // Xanh lá rất nhạt
  static const Color surfaceLight = Color(0xFFFFFFFF);
  static const Color cardBackground = Color(0xFFF5F5F5);

  // Màu accent
  static const Color accentBlue = Color(0xFF0288D1); // Xanh biển
  static const Color accentBrown = Color(0xFF8D6E63); // Nâu đất
  static const Color accentOlive = Color(0xFF7CB342); // Xanh olive
